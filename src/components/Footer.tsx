        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 Isoliertechnik Dutu. Alle Rechte vorbehalten. <a href="https://www.verosea.ro" target="_blank" className="text-gray-400 hover:text-white text-sm transition-colors duration-200">Verosea Web</a>
            </p>
